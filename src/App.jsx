...
const TF_LOGO = "data:image/png;base64,";
...
const STYLE = `
  ...
  *{box-sizing:border-box;margin:0;padding:0;}
  ...
  .login-input{width:100%;background:rgba(6,10,20,0.8);border:1px solid rgba(99,179,237,0.15);border-radius:10px;
  ...
  .login-input:focus{border-color:rgba(99,179,237,0.5);box-shadow:0 0 20px rgba(99,179,237,0.08);}
  .login-input::placeholder{color:#1e3a5f;}
  .login-btn{width:100%;padding:14px;border-radius:10px;
    background:linear-gradient(135deg,rgba(29,78,216,0.9),rgba(14,165,233,0.9));
    border:1px solid rgba(99,179,237,0.3);color:#fff;font-size:12px;font-weight:600;
    cursor:pointer;font-family:'DM Mono',monospace;letter-spacing:0.15em;
    transition:all 0.2s;text-transform:uppercase;}
  .login-btn:hover:not(:disabled){box-shadow:0 0 30px rgba(14,165,233,0.25);}
  .login-btn:disabled{background:rgba(12,20,32,0.8);border:1px solid #1e2d45;color:#1e3a5f;cursor:not-allowed;}
  ...
  @keyframes glow{0%,100%{text-shadow:0 0 20px rgba(99,179,237,0.3)}50%{text-shadow:0 0 40px rgba(99,179,237,0.6),0 0 80px rgba(14,165,233,0.2)}}
  .tf-logo-text{
    font-family:'Cinzel',serif;font-size:11px;font-weight:600;letter-spacing:0.4em;text-transform:uppercase;
    background:linear-gradient(90deg,#475569,#94a3b8,#475569);background-size:200% auto;
    -webkit-background-clip:text;-webkit-text-fill-color:transparent;
    animation:shimmer 5s linear infinite;
  }
  .god-title{
    font-family:'Cinzel',serif;font-size:28px;font-weight:700;letter-spacing:0.12em;
    background:linear-gradient(180deg,#ffffff 0%,#93c5fd 50%,rgba(14,165,233,0.7) 100%);
    -webkit-background-clip:text;-webkit-text-fill-color:transparent;
    animation:glow 4s ease-in-out infinite;
  }
  .login-card{
    animation:fadeUp 0.8s cubic-bezier(0.16,1,0.3,1) both;
    position:relative;background:rgba(3,6,15,0.9);
    border:1px solid rgba(99,179,237,0.1);border-radius:20px;
    padding:48px 44px;width:400px;box-sizing:border-box;
    backdrop-filter:blur(24px);
    box-shadow:0 0 100px rgba(14,165,233,0.05),0 40px 80px rgba(0,0,0,0.7),inset 0 1px 0 rgba(255,255,255,0.03);
  }
  /* ── Heaven interior ── */
  .heaven-bg{
    position:fixed;inset:0;pointer-events:none;z-index:0;
    background:
      radial-gradient(ellipse 140% 55% at 50% -8%, rgba(210,230,255,0.07) 0%, transparent 55%),
      radial-gradient(ellipse 80% 35% at 50% 0%, rgba(255,255,255,0.04) 0%, transparent 45%),
      radial-gradient(ellipse 50% 30% at 20% 100%, rgba(99,102,241,0.04) 0%, transparent 55%),
      radial-gradient(ellipse 40% 25% at 80% 90%, rgba(6,182,212,0.03) 0%, transparent 50%),
      #020408;
  }
  .heaven-rays{
    position:fixed;top:0;left:50%;transform:translateX(-50%);width:100%;height:70vh;
    pointer-events:none;z-index:0;
    background:
      repeating-conic-gradient(from -15deg at 50% -20%,
        rgba(180,210,255,0.025) 0deg 2deg,
        transparent 2deg 8deg,
        rgba(180,210,255,0.015) 8deg 10deg,
        transparent 10deg 18deg);
    mask-image:linear-gradient(to bottom, rgba(0,0,0,0.6) 0%, transparent 100%);
  }
  .heaven-logo{
    filter:invert(1) brightness(1.6) drop-shadow(0 0 16px rgba(255,255,255,0.35));
        ...
        <div style={{textAlign:"center",marginBottom:36}}>
          ...
          <div style={{position:"relative",marginBottom:8}}>
            <div style={{position:"absolute",top:"50%",left:"50%",transform:"translate(-50%,-50%)",
              width:280,height:60,borderRadius:"50%",
              background:"radial-gradient(ellipse,rgba(255,255,255,0.08) 0%,transparent 70%)",
              filter:"blur(12px)",pointerEvents:"none"}}/>
            <img src={TF_LOGO} alt="Targetflow"
              style={{width:240,height:"auto",
                filter:"invert(1) brightness(1.8) drop-shadow(0 0 24px rgba(255,255,255,0.5)) drop-shadow(0 0 50px rgba(147,197,253,0.35))",
                position:"relative"}}/>
          </div>
